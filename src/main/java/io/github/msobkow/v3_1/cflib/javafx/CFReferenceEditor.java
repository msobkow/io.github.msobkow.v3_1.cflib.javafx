...
extends AnchorPane
{
	public final static String PICK_ICON_RESOURCE = "/io.github.msobkow.v3_1.cflib/javafx.images/PickReference.gif";
	public final static String VIEW_ICON_RESOURCE = "/io.github.msobkow.v3_1.cflib/javafx.images/ViewReference.gif";
	...
	public interface ICFReferenceCallback {
		void chose( io.github.msobkow.v3_1.cflib.ICFLibAnyObj value );
		void view( io.github.msobkow.v3_1.cflib.ICFLibAnyObj value );
	}
